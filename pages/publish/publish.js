const GITHUB_CLIENT_ID = 'e6084ea0f71b0cfee2d0';
...
const initPage = () => {
    ...
    publishAnchor.setAttribute('href', `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&scope=public_repo&state=${randomString}&redirect_uri=${window.origin}/LABAPARstudio/pages/publish-confirm/index.html`);
